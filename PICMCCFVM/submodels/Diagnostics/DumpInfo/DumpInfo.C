...
Foam::DumpInfo<CloudType>::DumpInfo
(
...
template<class CloudType>
Foam::DumpInfo<CloudType>::DumpInfo(const DumpInfo<CloudType>& im)
:
...
template<class CloudType>
void Foam::DumpInfo<CloudType>::gatherDiagnostic(const typename CloudType::parcelType& p)
{}
