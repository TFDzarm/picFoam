...
Foam::CountInsertions<CloudType>::CountInsertions
(
...
template<class CloudType>
Foam::CountInsertions<CloudType>::CountInsertions(const CountInsertions<CloudType>& im)
:
...
template<class CloudType>
void Foam::CountInsertions<CloudType>::ejectionEvent(typename CloudType::parcelType& p, label patchId)
{
    countParcel_[patchId][p.typeId()]++;
    countParticle_[patchId][p.typeId()]+= p.nParticle();
}

template<class CloudType>
void Foam::CountInsertions<CloudType>::info()
{
