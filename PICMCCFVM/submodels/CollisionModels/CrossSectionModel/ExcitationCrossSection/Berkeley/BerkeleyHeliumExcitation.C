...
Foam::BerkeleyHeliumExcitationCS<CloudType,Type>::BerkeleyHeliumExcitationCS
(
...
Foam::scalar Foam::BerkeleyHeliumExcitationCS<CloudType,Type>::crossSection(scalar eVEnergy) const
{
    ...
    return 3.4e-19/(eVEnergy +200);
}


template<class CloudType, Foam::crossSectionType Type>
Foam::scalar Foam::BerkeleyHeliumExcitationCS<CloudType,Type>::threshold() const
{
    return 19.8;
}
