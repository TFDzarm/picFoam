...
namespace Foam
{
    ...
    //Field weigthing models
    makeFieldWeigthing();
    makeFieldWeigthingType(CellAverageFW);
    makeFieldWeigthingType(VolumeWeightingFW);

    //Charge distribution models
    makeChargeDistribution(CloudType);
    makeChargeDistributionType(CellAverage,CloudType)
    makeChargeDistributionType(VolumeWeighting,CloudType)
