...
Point(1) = {-L1/2,L2/2,L3/2};
Point(2) = {-L1/2,-L2/2,L3/2};
Point(3) = {-L1/2,-L2/2,-L3/2};
Point(4) = {-L1/2,L2/2,-L3/2};

Point(5) = {L1/2,L2/2,L3/2};
Point(6) = {L1/2,-L2/2,L3/2};
Point(7) = {L1/2,-L2/2,-L3/2};
Point(8) = {L1/2,L2/2,-L3/2};
...
//X
Transfinite Line {9:12} = L1/dx+1 Using Progression 1.0;
//Y
Transfinite Line {1:4} = L2/dx+1 Using Progression 1.0;
//Z
